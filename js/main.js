...
var translations = {
  tr: {
    ...
    // 3D Oda Planlayıcı Sayfası
    planner_hero_eyebrow: "Yeni Nesil Deneyim",
    planner_hero_title: "3D Oda Planlayıcı",
    planner_hero_lead: "Salonunuzun veya odanızın ölçülerini girin, koltuk modellerimizi yerleştirin ve nasıl duracağını gerçek ölçekte görün.",
    planner_step1_title: "1. Ölçüleri Girin",
    planner_step1_desc: "Odanızın genişlik ve derinliğini santimetre cinsinden girip sahneyi oluşturun.",
    planner_step2_title: "2. Koltuk Ekleyin",
    planner_step2_desc: "Yıldız, Nirvana, Golf, Versace veya Viyana modellerinden dilediğinizi sahneye ekleyin.",
    planner_step3_title: "3. Yerleştirin & İnceleyin",
    planner_step3_desc: "Ürünleri sürükleyip döndürerek odanıza en uygun yerleşimi bulun, sığıp sığmadığını anında görün.",
    planner_room_form_title: "Oda Ölçülerinizi Girin",
    planner_room_form_desc: "Gerçek santimetre ölçülerini girin; sahne otomatik olarak ölçeklendirilir.",
    planner_label_width: "Genişlik (cm)",
    planner_label_depth: "Derinlik (cm)",
    planner_label_height: "Duvar Yüksekliği (cm)",
    planner_btn_create: "Odayı Oluştur",
    planner_btn_update: "Odayı Güncelle",
    planner_library_title: "Koltuk Modeli Ekle",
    planner_library_desc: "Bir model seçip sahneye eklemek istediğiniz parçaya tıklayın.",
    planner_add_3lu: "3'lü Koltuk Ekle",
    planner_add_berjer: "Berjer Ekle",
    planner_view_3d: "3D Görünüm",
    planner_view_top: "Üstten Görünüm",
    planner_btn_reset_camera: "Kamerayı Sıfırla",
    planner_btn_clear: "Sahneyi Temizle",
    planner_btn_download: "Görseli İndir",
    planner_scene_items_title: "Yerleştirilen Ürünler",
    planner_empty_scene: "Henüz ürün eklemediniz. Yukarıdan bir model seçip sahneye ekleyin.",
    planner_no_room_notice: "Devam etmek için önce oda ölçülerinizi girip \"Odayı Oluştur\" butonuna basın.",
    planner_rotation_label: "Döndürme",
    planner_position_x: "X Konumu (cm)",
    planner_position_z: "Z Konumu (cm)",
    planner_remove_item: "Kaldır",
    planner_rotate_90: "90° Döndür",
    planner_status_ok: "Uygun",
    planner_status_outside: "Odanın dışında",
    ...
    planner_cta_lead: "Odanızın görselini indirip WhatsApp üzerinden bize gönderebilir, seçtiğiniz modeller için hemen fiyat teklifi alabilirsiniz.",
    planner_cta_wa: "WhatsApp'tan Fiyat Al",
    promo_planner_eyebrow: "Yeni Özellik",
    promo_planner_title: "Odanızda Nasıl Duracağını 3D Görün",
    promo_planner_desc: "Salonunuzun ölçülerini girin, koltuk modellerimizi sanal odanıza yerleştirin ve satın almadan önce gerçek ölçekte nasıl durduğunu keşfedin.",
    promo_planner_btn: "3D Oda Planlayıcıyı Dene",
  ...
  en: {
    ...
    planner_hero_eyebrow: "Next-Gen Experience",
    planner_hero_title: "3D Room Planner",
    planner_hero_lead: "Enter your living room's dimensions, place our sofa models inside it, and see exactly how they'll look at true scale.",
    planner_step1_title: "1. Enter Dimensions",
    planner_step1_desc: "Enter your room's width and depth in centimeters and build the scene.",
    planner_step2_title: "2. Add Sofas",
    planner_step2_desc: "Add any of the Yildiz, Nirvana, Golf, Versace, or Viyana models to the scene.",
    planner_step3_title: "3. Place & Review",
    planner_step3_desc: "Drag and rotate the pieces to find the best layout, and instantly see whether they fit.",
    planner_room_form_title: "Enter Your Room Dimensions",
    planner_room_form_desc: "Enter real centimeter measurements; the scene will be scaled automatically.",
    planner_label_width: "Width (cm)",
    planner_label_depth: "Depth (cm)",
    planner_label_height: "Wall Height (cm)",
    planner_btn_create: "Build Room",
    planner_btn_update: "Update Room",
    planner_library_title: "Add a Sofa Model",
    planner_library_desc: "Choose a model and click the piece you want to add to the scene.",
    planner_add_3lu: "Add 3-Seater Sofa",
    planner_add_berjer: "Add Armchair",
    planner_view_3d: "3D View",
    planner_view_top: "Top View",
    planner_btn_reset_camera: "Reset Camera",
    planner_btn_clear: "Clear Scene",
    planner_btn_download: "Download Image",
    planner_scene_items_title: "Placed Items",
    planner_empty_scene: "You haven't added any items yet. Pick a model above and add it to the scene.",
    planner_no_room_notice: "Enter your room dimensions and click \"Build Room\" to continue.",
    planner_rotation_label: "Rotation",
    planner_position_x: "X Position (cm)",
    planner_position_z: "Z Position (cm)",
    planner_remove_item: "Remove",
    planner_rotate_90: "Rotate 90°",
    planner_status_ok: "Fits",
    planner_status_outside: "Outside the room",
    ...
    planner_cta_lead: "Download an image of your room and send it to us on WhatsApp to get an instant quote for the models you chose.",
    planner_cta_wa: "Get a Price on WhatsApp",
    promo_planner_eyebrow: "New Feature",
    promo_planner_title: "See It in Your Room in 3D",
    promo_planner_desc: "Enter your living room's dimensions, place our sofa models inside your virtual room, and discover exactly how they'll look before you buy.",
    promo_planner_btn: "Try the 3D Room Planner",
...
var searchableItems = [
  ...
  {
    id: "planner",
    title_tr: "3D Oda Planlayıcı",
    title_en: "3D Room Planner",
    desc_tr: "Oda ölçülerinizi girin, koltuk modellerini yerleştirin ve nasıl duracağını görün",
    desc_en: "Enter your room dimensions, place sofa models, and see how they'll look",
    category_tr: "Araç",
    category_en: "Tool",
    url: "oda-planlayici.html",
    img: "images/cat-kanepe.jpg",
    tags: ["3d", "oda planlayıcı", "room planner", "ölçü", "simülasyon", "yerleşim", "planlama"]
  }
];
